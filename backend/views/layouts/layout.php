...
<body>
    ...
    <div class="navbar navbar-inverse">
        <div class="navbar-inner">
            ...
            <a class="brand" href="index.html" style="font-weight:700;font-family:Microsoft Yahei">YII2商城 - 后台管理</a>
            ...
            <ul class="nav pull-right">                
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="<?php echo yii\helpers\Url::to(['manager/changepassword'])?>">修改密码</a></li>
                        <li><a href="#">订单管理</a></li>
                    </ul>
                </li>
    ...
    <div id="sidebar-nav">
        <ul id="dashboard-menu">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="<?php echo yii\helpers\Url::to(['/manager/adminlist'])?>">管理员列表</a></li>
                    <li><a href="<?php echo yii\helpers\Url::to(['/manager/addadmin'])?>">加入新管理员</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="<?= yii\helpers\Url::to(['category/addcategory'])?>">添加分类</a></li>
                    <li><a href="<?= yii\helpers\Url::to(['category/categorylist'])?>">分类列表</a></li>
                </ul>
            </li>
            <li>
                <a class="dropdown-toggle" href="#">
                ...
                <ul class="submenu">
                    <li><a href="<?= yii\helpers\Url::to(['product/addproduct'])?>">添加商品</a></li>
