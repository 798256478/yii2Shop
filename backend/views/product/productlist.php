            ...
            <div id="pad-wrapper" class="users-list">
                <div class="row-fluid header">
                    ...
                    <div class="span10 pull-right">
                        <a href="<?php echo yii\helpers\Url::to(['product/addproduct']) ?>" class="btn-flat success pull-right">
                            <span>&#43;</span>
                            添加新商品
                        </a>
                    </div>
                ...
                <div class="row-fluid table">
                    <table class="table table-hover">
                        ...
                        <tr class="first">
                            <td>
                                <img src="<?php echo 'http://'.$product->cover.'?imageView2/2/w/50/h/50/interlace/0/q/100'; ?>" class="img-circle avatar hidden-phone" />
                            ...
                            <td>
                                <?php $on = ['不推荐', '推荐'] ?>
                                <?php echo $on[$product->isrecommend]; ?>
                            </td>
